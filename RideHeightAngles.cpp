...
// Find and return closest angle values to reach desired height
std::vector<int> getAngles(double desiredHeight) {
	int closestValue = 0;
	...
	return { ValueTable(closestValue)(2), ValueTable(closestValue)(3) };
}